...
#
#   julia --project=. scripts/make_diag_config.jl <label> [intra_mult] [n_weeks] [AC|DC] [inter_mult] [international_mult] [xb_split]
...
println("wrote scripts/config_diag_$(scen).toml")
