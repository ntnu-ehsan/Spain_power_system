...
| `Data/ts/EDF__*-ES__*.csv` | EDF wind/PV load factors and hydro coefficients, 37 climate years 1982–2018 — the SDDP scenarios |
| `Data/ts/EMPIRE/` | hourly NUTS3 series for PT/FR/EU in the SDDP |
