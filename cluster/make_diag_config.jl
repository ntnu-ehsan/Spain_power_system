...
#
#   julia --project=. cluster/make_diag_config.jl <label> [intra_mult] [n_weeks] [AC|DC] [inter_mult] [international_mult]
#   defaults:                                              10.0         2         DC      1.0         1.0
#
...
using TOML
scen  = length(ARGS) >= 1 ? ARGS[1] : error("usage: make_diag_config.jl <label> [intra_mult] [n_weeks] [AC|DC] [inter_mult] [international_mult]")
